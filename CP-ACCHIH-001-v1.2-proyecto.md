...
La clasificación normativa del perfil no dependerá del contenido textual del `Subject`, sino de la extensión `Certificate Policies`, mediante el OID institucional correspondiente al tipo de certificado emitido. Para perfiles objetivo nuevos, la relación perfil-OID deberá provenir del catálogo controlado y aprobado del Anexo A; mientras un perfil no cuente con OID aprobado no podrá emitirse. Los OID ausentes, desconocidos o incompatibles con un perfil objetivo nuevo deberán rechazarse o marcarse como no clasificables, sin inferir la clasificación desde el `Subject`. Los certificados históricos o de transición conservarán la ruta de validación prevista en la sección aplicable hasta su expiración o revocación.
